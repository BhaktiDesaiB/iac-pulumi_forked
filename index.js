...
const rdsInstance = new aws.rds.Instance("myrdsinstance", {
    ...
    username: "root",             // Database master username
    password: "root",     // Database master password
...
const dbHostname = pulumi.interpolate`${rdsInstance.address}`;
    ...
    const lambdaFunction = new aws.lambda.Function("lambdaFunction", {
        code: new pulumi.asset.FileArchive("C:/Users/bhakt/OneDrive/Desktop/a9/serverless_forked"),
        role: lambdaRole.arn,
